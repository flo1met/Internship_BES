---
title: "plots_new_2c_6p"
format: html
---
```{r}
load("../../data/archive/data_comp_2500_2c_6p.RData")
load("../../data/archive/data_part_2500_2c_6p.RData")
library(tidyverse)
library(ggplot2)
library(ggdist)
library(ggthemes)
...
data_part_filt <- data_part %>% filter(study == 6 & n_sample != 5000) %>%
